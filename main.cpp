...
// clang-format off
smlsearch entries[] = {
  {{ 0x77, 0x07, 0x01, 0x00, 0x01, 0x08, 0x00, 0xff, 0x65, 0x00, 0x1c, 0x01, 0x04, 0x01, 0x62, 0x1e, 0x52, 0xff }, 18, "1_8_0"},  
  {{ 0x77, 0x07, 0x01, 0x00, 0x02, 0x08, 0x00, 0xff, 0x01, 0x01, 0x62, 0x1e, 0x52, 0xff }, 14, "2_8_0"},  
  {{ 0x77, 0x07, 0x01, 0x00, 0x24, 0x07, 0x00, 0xff, 0x01, 0x01, 0x62, 0x1b, 0x52, 0x00 }, 14, "24_7_0"}, 
  {{ 0x77, 0x07, 0x01, 0x00, 0x38, 0x07, 0x00, 0xff, 0x01, 0x01, 0x62, 0x1b, 0x52, 0x00 }, 14, "38_7_0"},
  {{ 0x77, 0x07, 0x01, 0x00, 0x4c, 0x07, 0x00, 0xff, 0x01, 0x01, 0x62, 0x1b, 0x52, 0x00 }, 14, "4C_7_0"},
  {{ 0x77, 0x07, 0x01, 0x00, 0x20, 0x07, 0x00, 0xff, 0x01, 0x01, 0x62, 0x23, 0x52, 0xff }, 14, "20_7_0"},
  {{ 0x77, 0x07, 0x01, 0x00, 0x34, 0x07, 0x00, 0xff, 0x01, 0x01, 0x62, 0x23, 0x52, 0xff }, 14, "34_7_0"},
  {{ 0x77, 0x07, 0x01, 0x00, 0x51, 0x07, 0x1a, 0xff, 0x01, 0x01, 0x62, 0x08, 0x52, 0xff }, 14, "51_7_1A"},
  {{ 0x77, 0x07, 0x01, 0x00, 0x10, 0x07, 0x00, 0xff, 0x01, 0x01, 0x62, 0x1b, 0x52, 0x00 }, 14, "10_7_0"},
  {{ 0x77, 0x07, 0x01, 0x00, 0x51, 0x07, 0x02, 0xff, 0x01, 0x01, 0x62, 0x08, 0x52, 0xff }, 14, "51_7 2"}
};
// clang-format on
int smllen = 10;
    ...
    for (i = 0; i <= smlIndex; i++) {
      ...
      if (found){
        ...
        if (1==1){
          ...
          Serial.printf("%llu\n",smluknwn);
          uknwn = double(smluknwn);
          Serial.printf("%.3f\n",uknwn);

          char buffer[20];
          char* topic = "/energy/sml/";
          char* path = (char *) malloc(1 + strlen(clientId) + strlen(topic) + 8);
          strcpy(path, clientId);
          strcat(path, topic);
          strcat(path,entries[n].name);
          sprintf(buffer,"%.0f",uknwn);
          mqttClient.publish(path, buffer);
        }
      }
    }
